 ...
 */
function serializeTraceContext(traceContext) {
    //  0           1           2
    ...
    // also slice that off.)
    const base16SpanId = `0000000000000000${decToHex(traceContext.spanId).slice(2)}`.slice(-16);
    result.write(base16SpanId, 19, 8, 'hex');
    result.writeUInt8(2, 27);
    result.writeUInt8(traceContext.options || 0, 28);
    return result;
}
exports.serializeTraceContext = serializeTraceContext;
/**
 ...
 */
function deserializeTraceContext(buffer) {
...
exports.deserializeTraceContext = deserializeTraceContext;
